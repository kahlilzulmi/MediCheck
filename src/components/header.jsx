        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-8">
            ...
            <nav className="space-x-6 text-sm font-medium hidden lg:flex items-center">
              ...
              <button onClick={() => setDeviceModalOpen(true)} className="hover:underline font-semibold">
                Kelola Perangkat
              </button>
            </nav>
      ...
      {isDeviceModalOpen && (
        ...
        >
          <div className="bg-white p-8 rounded-lg shadow-2xl w-full max-w-lg relative text-black">
            <button onClick={() => setDeviceModalOpen(false)} className="absolute top-2 right-2 text-gray-500 hover:text-gray-800 text-2xl font-bold">&times;</button>
            <DeviceManager />
          </div>
        </div>
      )}
